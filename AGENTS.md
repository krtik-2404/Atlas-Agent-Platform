...
This document provides essential guidelines for AI agents working on the Atlas Agent Platform project.
...
- **PostgreSQL + pgvector** for vector-based semantic memory storage
...
- Efficient vector similarity search for memory retrieval
...
- **pgvector** - Vector storage for semantic memory
