...
- **AI & LLM Features**
  ...
  - Vector-based semantic memory using PostgreSQL and pgvector
  - LLM Service with automatic retry logic using tenacity
  - Multi-provider LLM support (OpenAI gpt-4o-mini, Google Gemini, local models via Ollama like llama3, mistral, phi3)
...
**Kartik Patil**  
GitHub: https://github.com/krtik-2404
...
# Application
APP_ENV=development
PROJECT_NAME="Atlas Agent Platform"
DEBUG=true
...
The Atlas Agent Platform includes vector-based semantic memory support using PostgreSQL and pgvector:
...
- **Multi-Provider Support**: OpenAI (gpt-4o-mini), Google Gemini, Ollama (llama3, mistral, phi3)
...
Atlas Agent Platform supports multiple LLM providers depending on configuration.

| Provider | Example Models | Cost |
|--------|----------------|------|
| Ollama (Local) | llama3, mistral, phi3 | Free |
| Google Gemini | gemini-1.5-flash | Free tier |
| Groq | llama3-70b, mixtral | Free tier |
| OpenAI | gpt-4o-mini | Optional (paid or free credits) |
