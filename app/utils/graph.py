...
def process_llm_response(response: BaseMessage) -> BaseMessage:
    """Process LLM response to handle structured content blocks from various LLM providers.

    Some LLM models may return content as a list of blocks like:
    [
...
def prepare_messages(messages: list[Message], llm: BaseChatModel, system_prompt: str) -> list[Message]:
    ...
    try:
        ...
        # Handle unrecognized content blocks from advanced LLM models
