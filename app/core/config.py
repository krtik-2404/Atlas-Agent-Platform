...
class Settings:
    ...
    def __init__(self):
        ...
        self.PROJECT_NAME = os.getenv("PROJECT_NAME", "Atlas Agent Platform")
        self.VERSION = os.getenv("VERSION", "0.1.0")
        self.DESCRIPTION = os.getenv(
            "DESCRIPTION", "A production-ready platform for building AI agents with LangGraph and Langfuse"
        )
        ...
        # Semantic Memory Configuration (pgvector)
        ...
        if not self.JWT_SECRET_KEY:
          raise RuntimeError("JWT_SECRET_KEY is not set in environment file.")
